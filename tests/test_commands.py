...
from src.geminiai_cli.commands import do_login, do_logout, do_update, do_check_update

@patch("src.geminiai_cli.commands.run")
@patch("src.geminiai_cli.commands.read_file", return_value="verification code")
...
@patch("src.geminiai_cli.commands.run")
@patch("src.geminiai_cli.commands.read_file", return_value="")
...
@patch("src.geminiai_cli.commands.run_capture", side_effect=["1.0.0", "1.0.0"])
def test_do_check_update_latest(mock_run_capture):
    do_check_update()

@patch("src.geminiai_cli.commands.run_capture", side_effect=["1.0.0", "1.0.1"])
...
@patch("src.geminiai_cli.commands.do_update")
